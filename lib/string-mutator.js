...
var content = function(txt, ctx) {
  var contentObj = {
    ...
    appendTxt: function(apTxt) {
      // console.log('prependTxt', txt, 'ap:', apTxt, this.lastOp, this.lastMatch);      
      var copy = txt.slice(0);
      switch (this.lastOp) {
        case 'before':
        case 'after':
          var index = txt.regexIndexOf(this.lastMatch);
    ...
    prependTxt: function(preTxt) {
      // console.log('prependTxt', txt, 'pre:', preTxt, this.lastOp, this.lastMatch);      
      var copy = txt.slice(0);
      switch (this.lastOp) {
        case 'before':
          var index = txt.regexIndexOf(this.lastMatch);
    ...
    before: function(startExpr, options) {
      ...
      var cutIndex = options.include ? startIndex : startIndex + startMatch.length;
